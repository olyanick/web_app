webix.protoUI({
	...
	demos:[
		...
		{ name:"files", 	link:"/download/", text:"Build your own file manager app using the multiple functions of Webix widgets. Uploading files, grouping them into folders and setting access to them is only a small part of all that is possible to do using the Webix library." },
